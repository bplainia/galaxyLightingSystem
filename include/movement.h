...
#define PIN_MOVE_UP_1 LATDbits.LATD7
#define PIN_MOVE_UP_2 LATDbits.LATD4
#define PIN_MOVE_DOWN_1 LATDbits.LATD6
#define PIN_MOVE_DOWN_2 LATDbits.LATD5

#define PIN_MOVE_EAST_1 LATBbits.LATB3
#define PIN_MOVE_EAST_2 LATBbits.LATB4
#define PIN_MOVE_WEST_1 LATBbits.LATB2
#define PIN_MOVE_WEST_2 LATBbits.LATB1
