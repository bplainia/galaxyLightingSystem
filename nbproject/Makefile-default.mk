...
SOURCEFILES_QUOTED_IF_SPACED=src/solarLight.c src/communication.c src/eeprom.c src/hid.c src/movement.c src/powerman.c src/sensors.c src/rtc.c src/shared.c src/menu.c src/light.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/solarLight.p1 ${OBJECTDIR}/src/communication.p1 ${OBJECTDIR}/src/eeprom.p1 ${OBJECTDIR}/src/hid.p1 ${OBJECTDIR}/src/movement.p1 ${OBJECTDIR}/src/powerman.p1 ${OBJECTDIR}/src/sensors.p1 ${OBJECTDIR}/src/rtc.p1 ${OBJECTDIR}/src/shared.p1 ${OBJECTDIR}/src/menu.p1 ${OBJECTDIR}/src/light.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/solarLight.p1.d ${OBJECTDIR}/src/communication.p1.d ${OBJECTDIR}/src/eeprom.p1.d ${OBJECTDIR}/src/hid.p1.d ${OBJECTDIR}/src/movement.p1.d ${OBJECTDIR}/src/powerman.p1.d ${OBJECTDIR}/src/sensors.p1.d ${OBJECTDIR}/src/rtc.p1.d ${OBJECTDIR}/src/shared.p1.d ${OBJECTDIR}/src/menu.p1.d ${OBJECTDIR}/src/light.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/solarLight.p1 ${OBJECTDIR}/src/communication.p1 ${OBJECTDIR}/src/eeprom.p1 ${OBJECTDIR}/src/hid.p1 ${OBJECTDIR}/src/movement.p1 ${OBJECTDIR}/src/powerman.p1 ${OBJECTDIR}/src/sensors.p1 ${OBJECTDIR}/src/rtc.p1 ${OBJECTDIR}/src/shared.p1 ${OBJECTDIR}/src/menu.p1 ${OBJECTDIR}/src/light.p1

# Source Files
SOURCEFILES=src/solarLight.c src/communication.c src/eeprom.c src/hid.c src/movement.c src/powerman.c src/sensors.c src/rtc.c src/shared.c src/menu.c src/light.c
...
${OBJECTDIR}/src/solarLight.p1: src/solarLight.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"include" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/src/solarLight.p1  src/solarLight.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"include" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 -I"include" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/firmware.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
